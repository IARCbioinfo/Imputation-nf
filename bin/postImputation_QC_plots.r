...
par_res <-  foreach(chr=c(21:22),.packages = c("data.table","ggplot2","gridExtra","viridis","ggplotify")) %dopar%{
  panel.frq=paste0("TOPMed_chr",chr,"_imputation_all.frq")
...
x_coords=sapply(21:22, function(chr){
